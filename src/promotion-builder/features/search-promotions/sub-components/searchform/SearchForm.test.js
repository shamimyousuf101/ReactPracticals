...
describe('<SearchForm/>', () => {
    ...
    beforeEach(() => {
        wrapper = shallow(<SearchForm value='we' onChange={onChangeMock} onSearchClick={onSearchClickMock}/>);
    })
    ...
    describe('Props', () => {
        ...
        it('should render correct value', () => {
            expect(wrapper.find('.search__form').children().find('SearchInput').prop('value')).toBe('we');
        })

        it('should render correct onChange handler', () => {
            expect(wrapper.find('.search__form').children().find('SearchInput').prop('onChange')).toBe(onChangeMock);
        })

        it('should render correct onSearchClick handler', () => {
            expect(wrapper.find('.search__form').children().find('SearchButton').prop('onSearchClick')).toBe(onSearchClickMock);
        })
